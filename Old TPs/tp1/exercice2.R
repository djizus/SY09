...
boxplot(crabs$FL[crabs$sp == "B"], crabs$FL[crabs$sp == "O"], main = "Observation de la variable FL selon l'espèce",  col = c("white", "red"), names = c("B", "O"), ylab = "nb crabes", notch = TRUE)
dev.off()

png(file = "img/boxplot_rw_espece.png")
boxplot(crabs$RW[crabs$sp == "B"], crabs$RW[crabs$sp == "O"], main = "Observation de la variable RW selon l'espèce",  col = c("white", "red"), names = c("B", "O"), ylab = "nb crabes", notch = TRUE)
dev.off()

png(file = "img/boxplot_cl_espece.png")
boxplot(crabs$CL[crabs$sp == "B"], crabs$CL[crabs$sp == "O"], main = "Observation de la variable CL selon l'espèce",  col = c("white", "red"), names = c("B", "O"), ylab = "nb crabes", notch = TRUE)
dev.off()

png(file = "img/boxplot_cw_espece.png")
boxplot(crabs$CW[crabs$sp == "B"], crabs$CW[crabs$sp == "O"], main = "Observation de la variable CW selon l'espèce",  col = c("white", "red"), names = c("B", "O"), ylab = "nb crabes", notch = TRUE)
dev.off()

png(file = "img/boxplot_bd_espece.png")
boxplot(crabs$BD[crabs$sp == "B"], crabs$BD[crabs$sp == "O"], main = "Observation de la variable BD selon le espèce",  col = c("white", "red"), names = c("B", "O"), ylab = "nb crabes", notch = TRUE)
dev.off()

png(file = "img/boxplot_fl_sexe.png")
boxplot(crabs$FL[crabs$sex == "M"], crabs$FL[crabs$sex == "F"], main = "Observation de la variable FL en fonction du sexe",  col = c("white", "red"), names = c("B", "O"), ylab = "nb crabes", notch = TRUE)
dev.off()

png(file = "img/boxplot_rw_sexe.png")
boxplot(crabs$RW[crabs$sex == "M"], crabs$RW[crabs$sex == "F"], main = "Observation de la variable RW en fonction du sexe",  col = c("white", "red"), names = c("B", "O"), ylab = "nb crabes", notch = TRUE)
dev.off()

png(file = "img/boxplot_cl_sexe.png")
boxplot(crabs$CL[crabs$sex == "M"], crabs$CL[crabs$sex == "F"], main = "Observation de la variable CL en fonction du sexe",  col = c("white", "red"), names = c("B", "O"), ylab = "nb crabes", notch = TRUE)
dev.off()

png(file = "img/boxplot_cw_sexe.png")
boxplot(crabs$CW[crabs$sex == "M"], crabs$CW[crabs$sex == "F"], main = "Observation de la variable CW en fonction du sexe",  col = c("white", "red"), names = c("B", "O"), ylab = "nb crabes", notch = TRUE)
dev.off()

png(file = "img/boxplot_bd_sexe.png")
boxplot(crabs$BD[crabs$sex == "M"], crabs$BD[crabs$sex == "F"], main = "Observation de la variable BD en fonction du sexe",  col = c("white", "red"), names = c("B", "O"), ylab = "nb crabes", notch = TRUE)
dev.off()
...
biplot(acpp, main = "Représentation des quatre individus dans le premier plan factoriel", xlab = "axe1", ylab = "axe2")
...
plot(corr, main = "Représentation des trois variables dans le premier plan factoriel", xlab = "axe1", ylab = "axe2", xlim = c(-1, 1), ylim = c(-1, 1), col = "red")
...
plot(acp$scores, main = "Représentation de tous les individus sur les axes 1 et 2", xlab = "axe1", ylab = "axe2", col = "red")
...
plot(corre, main = "Représentation des trois variables dans le premier plan factoriel", xlab = "axe1", ylab = "axe2", xlim = c(-1, 1), ylim = c(-1, 1), col = "red")
...
plot(cbind(corre[,1], corre[,3]), main = "Représentation des trois variables dans le deuxième plan factoriel", xlab = "axe1", ylab = "axe3", xlim = c(-1, 1), ylim = c(-1, 1), col = "red")
...
biplot(acp2, main = "Corrélation sans traitement")
abline(lty = 1, a = 0, b = 0, col = 1)
abline(lty = 1, a = 0, b = 1000000, col = 1)
dev.off()
...
biplot(acp3, main = "Corrélation après traitement")
abline(lty = 1, a = 0, b = 0, col = 1)
abline(lty = 1, a = 0, b = 1000000, col = 1)
dev.off()
...
#x11()
#barplot(rbind(hist1$counts, hist2$counts), col = c("blue","red"), beside = T, main = "Observation de la variable FL selon le espèces", legend.text = T, ylab = "nb crabes")

# NB: À faire pour chaque variable en fonction du sexe et de l'espèce (x10 histogrammes)

#barplot(rbind(NonSmoke, Smoke), space = 0,legend = levels('Smoke'), main = "Comparaison du niveau d'Observation des mères", col = c('blue','red'), xlab = "niveaux d'Observation", ylab = "nb femmes", legend.text = T)
